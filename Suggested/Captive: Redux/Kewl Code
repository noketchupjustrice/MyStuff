...
if game.PlaceId == 3388553819 then
    ...
    Section:NewToggle(
        "Loop Stealth Ability",
        "Loop Toggle Stealth Ability",
    ...
    Section:NewButton(
        ...
        "Enables Speed Invisibility Once",
        function()
    ...
    Section:NewToggle(
        "Loop Invisibility Ability",
        "Loop Toggle Invisibility Ability",
        function(toggleinvisiblity)
            local args = {[1] = "Invisibility"}
    ...
    Section:NewButton(
        "Player Radar Ability",
        "Enables Player Radar Once",
        function()
    ...
    Section:NewToggle(
        "Loop Player Radar Ability",
        "Loop Toggle Player Radar Ability",
        function(toggleplayerradar)
            local args = {[1] = "PlayerRadar"}
    ...
    Section:NewButton(
        "Shape Shifter Ability",
        "Enables Shape Shifter Once",
        function()
    ...
    Section:NewToggle(
        "Loop Shape Shifter Ability",
        "Loop Toggle Shape Shifter Ability",
        function(toggleshapeshifter)
            local args = {[1] = "ShapeShifter"}
    ...
    Section:NewToggle(
        "Loop Beast Radar Ability",
        "Loop Toggle Beast Radar Ability",
        function(toggleBeastradar)
            local args = {[1] = "BeastRadar"}
    ...
    Section:NewButton(
        "Third Person Once",
        "Only Changes Into Third Person Once",
        function()
            game.Players.LocalPlayer.CameraMode = "Classic"
        end
    )
    Section:NewButton(
        "First Person Once",
        "Only Changes Into First Person Once",
        function()
            game.Players.LocalPlayer.CameraMode = "LockFirstPerson"
        end
    )
    ...
    Section:NewButton(
        "Redeem All Hidden Codes",
        "Redeems All Twitter Codes",
        function()
    ...
    Section:NewButton(
        "Redeem Supercomputer Code",
        "Redeems Supercomputer Twitter Code",
        function()
            code = {[1] = "TwitterCode", [2] = "Supercomputer"}
            game:GetService("ReplicatedStorage").ProjectGemma.Remotes.rFunc:InvokeServer(unpack(code))
        end
    ...
    Section:NewButton(
        "Teleport To Hideen Code #1 | Redux",
        "Teleports To Hideen Code #1",
        function()
    ...
    Section:NewButton(
        "Teleport To Hideen Code #2 | Spleef",
        "Teleports To Hideen Code #2",
        function()
            local TweenS = game:GetService("TweenService")
            local tween =
                TweenS:Create(
    ...
    Section:NewButton(
        "Teleport To Hideen Code #3 | Acrobat",
        "Teleports To Hideen Code #3",
        function()
            local TweenS = game:GetService("TweenService")
            local tween =
                TweenS:Create(
    ...
    Section:NewButton(
        "Teleport To Hideen Code #4 | Supercomputer",
        "Teleports To Hideen Code #4",
        function()
            local TweenS = game:GetService("TweenService")
            local tween =
                TweenS:Create(
    ...
    Section:NewButton(
        "Teleport To Hideen Code #5 | Beast",
        "Teleports To Hideen Code #5",
        function()
            local TweenS = game:GetService("TweenService")
            local tween =
                TweenS:Create(
    ...
    Section:NewButton(
        "Everything :3 | noketchupjustrice#3666",
        "",
        function()
